...
.metrics-trend-chart .metric-chart-grid line{stroke:var(--border-muted);stroke-width:1;shape-rendering:crispEdges;vector-effect:non-scaling-stroke}
.metrics-trend-chart .metric-chart-jobs-area{fill:var(--accent-fg);fill-opacity:.10}
.metrics-trend-chart .metric-chart-jobs-line{fill:none;stroke:var(--accent-fg);stroke-width:1.5;stroke-linecap:butt;stroke-linejoin:miter;vector-effect:non-scaling-stroke}
.metrics-trend-chart .metric-chart-success-line{fill:none;stroke:var(--success-fg);stroke-width:1.5;stroke-dasharray:4 4;stroke-linecap:butt;stroke-linejoin:miter;vector-effect:non-scaling-stroke}
