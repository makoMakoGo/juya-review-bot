...
.metrics-segmented { display: inline-flex; align-items: center; gap: 2px; padding: 3px; border: 1px solid var(--border); border-radius: 8px; background: var(--bg-subtle); }
.metrics-segmented a { display: inline-flex; align-items: center; justify-content: center; min-height: 28px; padding: 4px 11px; border: 1px solid transparent; border-radius: 6px; color: var(--fg-muted); font-size: 12px; font-weight: 500; line-height: 1; text-decoration: none; white-space: nowrap; }
...
.metrics-section-heading { display: grid; gap: 2px; }
...
.metrics-list-item { display: grid; gap: 8px; padding: 13px 16px; border-bottom: 1px solid var(--border); }
.metrics-list-item:last-child { border-bottom: 0; }
.metrics-list-line { display: grid; grid-template-columns: minmax(0, 1fr) auto; align-items: baseline; gap: 12px; }
...
.metrics-list-meta { color: var(--fg-muted); font-size: 12px; font-variant-numeric: tabular-nums; white-space: nowrap; }
...
.metrics-comparison-title { display: flex; align-items: center; justify-content: space-between; gap: 10px; margin-bottom: 10px; }
.metrics-comparison-title strong { color: var(--text); font-size: 13px; }
...
.metrics-comparison-value small { color: var(--fg-subtle); font-size: 10px; font-weight: 600; }
