...
.metrics-summary-value { margin-top: 4px; color: var(--fg-default); font-size: 26px; font-weight: 300; letter-spacing: -0.01em; line-height: 1.2; font-variant-numeric: tabular-nums; }
...
.metrics-summary-pair strong { color: var(--fg-default); font-size: 18px; font-weight: 500; font-family: var(--font-mono); font-variant-numeric: tabular-nums; }
...
.metrics-bar { height: 4px; overflow: hidden; border-radius: 999px; background: var(--canvas-subtle); }
...
.metrics-day-value strong { color: var(--fg-default); font-size: 14px; font-weight: 500; font-family: var(--font-mono); font-variant-numeric: tabular-nums; }
...
.metrics-comparison-value strong { color: var(--fg-default); font-size: 14px; font-weight: 500; font-family: var(--font-mono); font-variant-numeric: tabular-nums; }
